...
export default {
  ...
  todoPage: {
    ...
    remindAtLabel: "Reminder time",
    remindAtHint: "A system notification fires at this time; leave empty for no reminder",
    remindNone: "Set reminder",
    remindNotifyTitle: "📌 To-Do Reminder",
    taskFallback: "To-do",
  },
  schedulePage: {
  ...
  pomodoro: {
    ...
    // Phase end: system notification + in-app dialog (phases never chain automatically)
    notifyWorkEndTitle: "🍅 Focus finished",
    notifyWorkEndBody: "Take a {minutes}-minute break and stretch a little",
    notifyBreakEndTitle: "☕ Break over",
    notifyBreakEndBody: "Start focus round {current} / {total} ({label})",
    notifyAllDoneTitle: "🎉 Pomodoro complete",
    notifyAllDoneBody: "All {total} focus rounds are done",
    phaseWorkEndTitle: "Focus finished",
    phaseWorkEndBody: "Round {current} / {total} done. Time for a {minutes}-minute break.",
    phaseBreakEndTitle: "Break over",
    phaseBreakEndBody: "Start focus round {current} / {total} ({label}), {minutes} minutes.",
    phaseAllDoneTitle: "Pomodoro complete",
    phaseAllDoneBody: "All {total} focus rounds are done 🎉",
    continueBtn: "Continue",
    stopBtn: "End pomodoro",
  },
  resourceSync: {
